...
__all__ = ["CampaignUpdateParams", "StandardCampaignParams", "ExternalCampaignParams"]
...
class StandardCampaignParams(TypedDict, total=False):
    ...
    volume: Required[Literal["high", "low"]]
...
CampaignUpdateParams: TypeAlias = Union[StandardCampaignParams, ExternalCampaignParams]
