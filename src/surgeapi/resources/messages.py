...
class MessagesResource(SyncAPIResource):
    ...
    def send(
        ...
        account_id: str,
        *,
        conversation: message_send_params.Variant0Conversation,
        attachments: Iterable[message_send_params.Variant0Attachment] | NotGiven = NOT_GIVEN,
    ...
    def send(
        ...
        *,
        to: str,
        attachments: Iterable[message_send_params.Variant1Attachment] | NotGiven = NOT_GIVEN,
        body: str | NotGiven = NOT_GIVEN,
    ...
    def send(
        ...
        account_id: str,
        *,
        conversation: message_send_params.Variant0Conversation | NotGiven = NOT_GIVEN,
        attachments: Iterable[message_send_params.Variant0Attachment] | NotGiven = NOT_GIVEN,
        body: str | NotGiven = NOT_GIVEN,
        send_at: Union[str, datetime] | NotGiven = NOT_GIVEN,
