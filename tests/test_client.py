...
class TestSurge:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Surge(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Surge) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.messages.with_streaming_response.create(
                account_id="acct_01j9a43avnfqzbjfch6pygv1td", conversation={}
            ).__enter__()
...
class TestAsyncSurge:
    ...
    def test_base_url_trailing_slash(self, client: AsyncSurge) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncSurge) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncSurge) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncSurge(base_url=base_url, api_key=api_key, _strict_response_validation=False)
