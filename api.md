...
```python
from surge.types import Campaign, CampaignResendBrandVerificationMessageResponse
```
...
- <code title="post /accounts/{account_id}/brand_verification_messages">client.campaigns.<a href="./src/surge/resources/campaigns.py">resend_brand_verification_message</a>(account_id) -> <a href="./src/surge/types/campaign_resend_brand_verification_message_response.py">CampaignResendBrandVerificationMessageResponse</a></code>
...
- <code title="get /accounts/{account_id}/users">client.users.<a href="./src/surge/resources/users.py">list</a>(account_id, \*\*<a href="src/surge/types/user_list_params.py">params</a>) -> <a href="./src/surge/types/user.py">SyncCursor[User]</a></code>
